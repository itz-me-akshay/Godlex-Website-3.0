    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-base md:text-lg text-white/70 mb-8 leading-relaxed">
            Welcome to Godlex SMP, a premium Minecraft survival multiplayer server built for passionate players. Experience an immersive, community-driven world with unique ranks, events, and a thriving player base.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-8">
            <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 backdrop-blur-md">
              <span className="text-xs text-white/40 font-semibold uppercase tracking-wider">Java</span>
              <span className="text-white font-mono text-sm">{javaIP}</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 backdrop-blur-md">
              <span className="text-xs text-white/40 font-semibold uppercase tracking-wider">Bedrock</span>
              <span className="text-white font-mono text-sm">{bedrockIP}</span>
              <span className="text-white/40 text-sm">:{bedrockPort}</span>
            </div>
          </div>
